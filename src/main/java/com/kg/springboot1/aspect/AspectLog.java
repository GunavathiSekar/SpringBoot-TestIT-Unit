package com.kg.springboot1.aspect;
...
public class AspectLog implements ThrowsAdvice {
    ...
    @Pointcut("execution(* com.kg.springboot1.service.*.*(..))")
    public void controller() {
    }
    @Pointcut("execution(* com.kg.springboot1.service.*.*(..))")
    protected void allMethod() {
    }
    @Before("execution(* com.kg.springboot1.*.*.*(..))")
...
@AfterThrowing(pointcut = "within(@org.springframework.stereotype.* *||@org.springframework.stereotype.Controller * )", throwing = "exception")
...
@AfterThrowing(pointcut="execution(* com.kg.springboot1.Controller.*.*(..))", 
        throwing="excep")
