...
@SpringBootTest(classes = Springboot1Application.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
...
public class EmployeeControllerIT {
  ...
  public void getAll() {
   ...
   public void deleteById() { 
       when().delete(EVENT_RESOURCE4, secondEvent.getEmployeeId()).then().statusCode(HttpStatus.SC_NO_CONTENT);
   }
