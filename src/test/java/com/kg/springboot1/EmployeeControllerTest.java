...
public class EmployeeControllerTest {
   ...
   private static final long EMPLOYEE_ID = 1L;
    private static final Employee EXISTING_EMPLOYEE = new EmployeeBuilder().EmployeeId(1L).Department("abc").Build();
    // private static final Employee ANOTHER_EMPLOYEE = new EmployeeBuilder().EmployeeId(2L).Department("def").Build();
   private static final Employee NEW_EMPLOYEE = new EmployeeBuilder().Department("abc").EmployeeId(2L).FirstName("krishna").Build();
